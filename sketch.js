...
function preload() {
  earrings.push(loadImage('pic/acc1_ring.png'));
  earrings.push(loadImage('pic/acc2_pearl.png'));
  earrings.push(loadImage('pic/acc3_tassel.png'));
  earrings.push(loadImage('pic/acc4_jade.png'));
  earrings.push(loadImage('pic/acc5_phoenix.png'));
}
